...
class LeadsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addIndexColumn()
            ->rawColumns(['status', 'action', 'client_name', 'next_follow_up_date', 'agent_name','mobile']);
    }
...
//        dd($currentDate);
        $lead = Lead::select('leads.id', 'leads.client_id','leads.mobile' ,'leads.next_follow_up', 'client_name', 'company_name', 'lead_status.type as statusName', 'status_id', 'leads.created_at','leads.value', 'lead_sources.type as source', 'users.name as agent_name', 'users.image',
